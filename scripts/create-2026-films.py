...
For posters, stills, BTS, group photos, generated thumbs, and trailers
after pages exist, use scripts/import-2026-media.py. Generated thumbs live
in thumb/<team>/<team>-thumb-<#>.jpg. Trailers become CDN trailer.mp4.
"""
