...
type: events
summary: >
  Strut your style on our purple carpet, then head into The Grand | Ritz
  Theater in Escondido for the Best of San Diego films and the awards gala.
...
params:
  featured: true
  image: 2026-gala-post.png
  image_wide: 2026-gala-horiz.png
  ...
  location_details: >
    ...
    amenities, on the corner of Grand Avenue and Juniper Street. Parking in
    nearby public lots and street parking along Grand and Juniper.
  location_url: https://www.thegrandescondido.org/
  location_socials:
    - text: TheGrandEscondido.org
      url: https://www.thegrandescondido.org/
      icon: globe
  location_links: []
...
**Purple carpet 5-6pm**, then the films and awards until 9pm, at
